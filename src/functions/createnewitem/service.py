...
def create_new_item_if_not_exist_in_my_list(table_name: str, title: str, status: str, type: str) -> bool:
    exist_in_my_list = dynamodb.find_items_by_title_and_type(table_name, title, type)
